...
pub const PAUSE_MENU_STYLE: Style = Style {
    ...
    size: Size::new(Val::Percent(40.0), Val::Percent(75.0)),
    gap: Size::new(Val::Px(15.0), Val::Px(20.0)),
...
// Making this a function instead of a constant because it needs to access the asset_server!!
